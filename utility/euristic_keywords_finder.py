...
# Project Notes: This script was mainly generated by LLMs, but carefully reworked thorugh different iterations of prompt engineering.
...
def extract_keywords(texts: list, top_n: int = 50) -> list:
    ...
    # Restituisce una lista di stringhe formattate per il salvataggio
...
def build_comprehensive_keywords():
    ...
    print("Calcolo pesi TF-IDF in corso (potrebbe richiedere un minuto)...")
    ...
    # Crea la cartella src se non esiste e prepara il file
    ...
    print(f"\nSalvataggio completato! File creato in: {output_file.resolve()}")
